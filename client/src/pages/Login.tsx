...
import { Sprout, Mail, Lock, Eye, EyeOff, Loader2, Chrome } from "lucide-react";
import { toast } from "sonner";
import { AuthError } from "firebase/auth";
import { cn } from "@/lib/utils";

export default function Login() {
  const { signInWithGoogle, signInWithEmail, loading } = useFirebaseAuth();
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-5 py-10"
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Grow beyond cash support</p>
        </div>
        ...
        <div className="rounded-3xl p-6 shadow-lg"
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-3">
            ...
            <div className="text-right">
              <a href="/forgot-password" className="text-xs font-medium hover:underline" style={{ color: "oklch(0.52 0.16 145)" }}>
        ...
        <p className="text-center text-sm text-muted-foreground mt-5">
          Wala pang account?{" "}
          <a href="/signup" className="font-semibold hover:underline" style={{ color: "oklch(0.52 0.16 145)" }}>
            Mag-sign up / Create account
          </a>
        </p>
